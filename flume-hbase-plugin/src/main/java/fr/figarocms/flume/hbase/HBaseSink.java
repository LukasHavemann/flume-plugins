 ...
 * write speed. The default is 2MB.
 *
...
public class HBaseSink extends EventSink.Base {
  ...
  /**
   * Column family validity check happens in open(), so we through an IOException (ideally invalid column families would
   * be a IllegalArgumentException but this exn doesn't make sense on open)
   */
